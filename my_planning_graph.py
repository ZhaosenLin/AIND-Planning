...
class PlanningGraph():
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        return len([node for node in node_a1.action.effect_add if node in node_a2.action.effect_rem]) > 0 or \
               len([node for node in node_a2.action.effect_add if node in node_a1.action.effect_rem]) > 0
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        return len([node for node in node_a1.action.effect_add if node in node_a2.action.precond_neg]) > 0 or \
               len([node for node in node_a2.action.effect_add if node in node_a1.action.precond_neg]) > 0 or \
               len([node for node in node_a2.action.effect_rem if node in node_a1.action.precond_pos]) > 0 or \
               len([node for node in node_a1.action.effect_rem if node in node_a2.action.precond_pos]) > 0
    ...
    def competing_needs_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        for p_1 in node_a1.parents:
            for p_2 in node_a2.parents:
                if p_1.is_mutex(p_2):
                    return True
        return False
    ...
    def inconsistent_support_mutex(self, node_s1: PgNode_s, node_s2: PgNode_s):
        ...
        for p_s1 in node_s1.parents:
            for p_s2 in node_s2.parents:
                if not p_s1.is_mutex(p_s2):
                    return False
        return True
